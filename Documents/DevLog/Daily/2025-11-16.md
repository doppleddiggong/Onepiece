...
- [feat] feat: 개념 설명을 위한 이미지 자료 추가 — 영향: 기능 추가

- [fix] fix(ci): correct daily-report workflow date logic to use yesterday — 영향: 버그 수정

- [other] Merge pull request #25 from doppleddiggong/dopple — 영향: 기타 변경
...
```mermaid
flowchart LR
  Dev[Commits: 8] --> Build[UE5 Build/Cook]
